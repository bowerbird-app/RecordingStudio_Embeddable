...
class RenameRecordingStudioEmbeddableViewsToEmbeddableViewLogs < ActiveRecord::Migration[8.1]
  ...
  NEW_TABLE = :recording_studio_embeddable_view_logs
  ...
  INDEX_RENAMES = {
    ...
    "index_recording_studio_embeddable_views_on_embed_id" => "index_recording_studio_embeddable_view_logs_on_embed_id"
  }.freeze
