...
module RecordingStudioEmbeddable
  ...
  #   RecordingStudioEmbeddable.configuration.hooks.after_initialize do
  #     Rails.logger.info "RecordingStudioEmbeddable initialized!"
  #   end
  #
  # @example Running hooks
  #   RecordingStudioEmbeddable::Hooks.run(:after_initialize)
  #
  class Hooks
    ...
    def log_hook_error(error, event_name, _hook)
      ...
      Rails.logger.error "[RecordingStudioEmbeddable::Hooks] Error in #{event_name} hook: #{error.message}"
    ...
    class << self
      ...
      # @return [Array] Results from all hooks
      def run(event_name, *)
        RecordingStudioEmbeddable.configuration.hooks.run(event_name, *)
      end
      ...
      def run_around(event_name, context, &)
        RecordingStudioEmbeddable.configuration.hooks.run_around(event_name, context, &)
      end
